...
import {
  ...
  DeleteCategorySchema, ToggleCategorySchema,
...
export type CategoryToggleState = ActionResultFrom<typeof ToggleCategorySchema, CategorySuccess>

export const categoryToggleInitialState: CategoryToggleState = {
  ok: false as const,
  data: null,
  errors: {},
}
